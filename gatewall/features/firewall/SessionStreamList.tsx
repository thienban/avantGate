  ...
  return (
    <div className="flex flex-col space-y-3">
      <div className="flex items-center justify-between px-1">
        ...
        <span className="text-[10px] text-zinc-500 font-mono">Stream Live</span>
      </div>
          ...
          return (
            <div
              ...
              className={`p-3.5 rounded-xl border cursor-pointer transition-all ${
                isSelected
                  ? "border-emerald-500/50 bg-emerald-950/20 shadow-md shadow-emerald-500/10 ring-1 ring-emerald-500/30"
            ...
            >
              ...
              <div className="flex items-center justify-between text-xs text-zinc-400 mb-2">
                <span className="text-zinc-300 font-medium truncate">{session.agentName}</span>
